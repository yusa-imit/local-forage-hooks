...
function useDBInitWithFetch(KeyValue, table, db_name, customDependancy) {
        ...
        function set() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, KeyValue()];
                        case 1:
                            kv = _a.sent();
                            return [4 /*yield*/, functions_1.default.setDBBulkItem(table, kv, db_name)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    }, __spreadArray([table, db_name], customDependancy, true));
    return loading;
}
exports.useDBInitWithFetch = useDBInitWithFetch;
