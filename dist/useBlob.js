 ...
 */
function useBlob(key, table, url, db_name, SAVE_IF_NULL, CHECK_NULL_RESULT) {
    var _a = (0, react_1.useState)(new Blob()), data = _a[0], setData = _a[1];
    var _b = (0, react_1.useState)(true), loading = _b[0], setLoading = _b[1];
    var _c = (0, react_1.useState)(true), nullState = _c[0], setNullState = _c[1];
    (0, react_1.useEffect)(function () {
        ...
        function get() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, functions_1.default.getDBBlob(table, key, url ? url : undefined, SAVE_IF_NULL, db_name)];
        ...
        get().then(function (value) {
            if (CHECK_NULL_RESULT === true) {
                if (value === null) {
                    setNullState(function (prev) { return !prev; });
                    return;
                }
            }
            setData(value);
